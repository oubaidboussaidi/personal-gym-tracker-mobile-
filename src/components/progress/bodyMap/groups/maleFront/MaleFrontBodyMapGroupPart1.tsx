...
export const MaleFrontBodyMapGroupPart1: React.FC = () => (
  <>
    <defs>
      <radialGradient
        id="jointradial"
    ...
    <g id="quads" className="bodymap bodymap text-mw-gray">
      <path
    ...
    <g id="abdominals" className="bodymap bodymap text-mw-gray" fill="mw-red">
      <path
    ...
    <g className="bodymap bodymap text-mw-gray" id="biceps">
      <path
    ...
    <g id="chest" className="bodymap bodymap text-mw-gray">
      <path
