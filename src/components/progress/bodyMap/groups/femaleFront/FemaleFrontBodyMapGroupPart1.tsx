...
export const FemaleFrontBodyMapGroupPart1: React.FC = () => (
  <>
    <defs>
      <radialGradient
        id="jointradial"
    ...
    <g id="abdominals" className="bodymap bodymap text-mw-gray">
      <path
    ...
    <g id="biceps" className="bodymap bodymap text-mw-gray">
      <path
